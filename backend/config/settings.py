...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-hospora-change-in-production-xyz123')
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Hospora API',
    'DESCRIPTION': 'Hospital Management Software API',
    'VERSION': '1.0.0',
}
